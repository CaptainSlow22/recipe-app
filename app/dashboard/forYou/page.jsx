            ...
            {users.map(user => (
              <div key={user._id} className='flex flex-col items-center'>
                  ...
                  <Link key={user._id} href={`/dashboard/user/${user._id}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" color='white' viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mt-2 rounded-full px-1 py-1 bg-green-600 size-10">
