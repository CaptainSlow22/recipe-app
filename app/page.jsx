    ...
    <main>
      <div className="flex flex-col md:flex-row items-center justify-center h-screen px-8 md:px-10 lg:px-32">
        <div className="flex flex-col w-full">
          ...
          <h1 className="text-4xl md:text-4xl lg:text-8xl text-left font-black ">from all over the world🌎</h1>
        ...
        <div className="hidden md:flex md:flex-col md:items-center md:h-screen md:w-screen">
        <Spline
